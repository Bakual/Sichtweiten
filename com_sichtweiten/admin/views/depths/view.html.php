 ...
 * @since  1.3.0
 */
class SichtweitenViewDepths extends HtmlView
{
	/**
	 * @var    array
	 * @since  1.3.0
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_SICHTWEITEN_DEPTHS_TITLE'), 'users');

		if ($canDo->get('core.create'))
		{
			ToolbarHelper::addNew('depth.add');
		}

		if ($canDo->get('core.edit'))
		{
			ToolbarHelper::editList('depth.edit');
		}

		if ($canDo->get('core.delete'))
		{
			ToolbarHelper::deleteList('COM_SICHTWEITEN_CONFIRM_DELETE', 'depths.delete');
		}
