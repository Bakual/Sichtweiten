...
class SichtweitenViewVisibility extends HtmlView
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(Text::sprintf('COM_SICHTWEITEN_PAGE_EDIT', Text::_('COM_SICHTWEITEN_VISIBILITIES_TITLE'), Text::_('COM_SICHTWEITEN_VISIBILITY_TITLE')), 'pencil-2');
