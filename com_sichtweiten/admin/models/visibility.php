 ...
 * @since     1.3.0
 */
class SichtweitenModelVisibility extends AdminModel
{
	/**
	 ...
	 * @since   1.3.0
	 */
	public function getTable($name = 'Sichtweite', $prefix = 'SichtweitenTable', $options = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_sichtweiten.edit.visibility.data', array());
